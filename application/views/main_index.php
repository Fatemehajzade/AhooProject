...
<!--						<input class="form-control ml-3" type="text" placeholder="جستجو ...">-->
				...
				<div class="row">
					<div class="col-12 d-flex flex-row justify-content-between">
						<div class="d-flex justify-content-center align-items-center text-center pl-4">
							<a href="<?php echo base_url() ?>index.php/ahooController/insidePoet/7">
								<div class="imgcu imgcu2">
									<img src="<?php echo base_url() ?>files/Sohrab.jpg" alt="Sohrab" width="122px">
									<div class="imghcolor"></div>
									<div class="imgtxt">
										<p class="mb-0">سهراب</p>
									</div>
								</div>
							</a>
						</div>
						<div class="d-flex justify-content-center align-items-center text-center pl-4">
							<a href="<?php echo base_url() ?>index.php/ahooController/insidePoet/2">
								<div class="imgcu imgcu2">
									<img src="<?php echo base_url() ?>files/Khayam.jpg" alt="Sohrab" width="122px">
									<div class="imghcolor"></div>
									<div class="imgtxt">
										<p class="mb-0">خیام</p>
									</div>
						...
						<div class="d-flex justify-content-center align-items-center text-center pl-4">
							<a href="<?php echo base_url() ?>index.php/ahooController/insidePoet/4">
								<div class="imgcu imgcu2">
									<img src="<?php echo base_url() ?>files/Molana.jpg" alt="Sohrab" width="122px">
									<div class="imghcolor"></div>
									<div class="imgtxt">
						...
						<div class="d-flex justify-content-center align-items-center text-center pl-4">
							<a href="<?php echo base_url() ?>index.php/ahooController/insidePoet/1">
								<div class="imgcu imgcu2">
									<img src="<?php echo base_url() ?>files/Hafez.jpg" alt="Sohrab" width="170px">
									<div class="imghcolor"></div>
									<div class="imgtxt">
										<p class="mb-0">حافظ</p>
									</div>
						...
						<div class="d-flex justify-content-center align-items-center text-center pl-4">
							<a href="<?php echo base_url() ?>index.php/ahooController/insidePoet/6">
								<div class="imgcu imgcu2">
									<img src="<?php echo base_url() ?>files/Saadi.jpg" alt="Sohrab" width="122px">
									<div class="imghcolor"></div>
									<div class="imgtxt">
										<p class="mb-0">سعدی</p>
									</div>
						...
						<div class="d-flex justify-content-center align-items-center text-center pl-4">
							<a href="<?php echo base_url() ?>index.php/ahooController/insidePoet/3">
								<div class="imgcu imgcu2">
									<img src="<?php echo base_url() ?>files/Hooshang.jpg" alt="Sohrab" width="122px">
									<div class="imghcolor"></div>
									<div class="imgtxt">
						...
						<div class="d-flex justify-content-center align-items-center text-center4">
							<a href="<?php echo base_url() ?>index.php/ahooController/insidePoet/5">
								<div class="imgcu imgcu2">
									<img src="<?php echo base_url() ?>files/farrokhi.jpg" alt="Sohrab" width="122px">
									<div class="imghcolor"></div>
									<div class="imgtxt">
